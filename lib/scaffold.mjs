...
import { resolvePageDir } from "./_workspace.mjs";
...
function printHelp() {
  console.log(`clawpage scaffold <template-name> <target> [--force]

Copy a shipped template into a new page directory.

<target> resolution:
  - Bare name (e.g. "my-dashboard") → ~/.clawpage/pages/<name>
  - Path (contains "/", starts with "." or "~", or absolute) → resolved relative to cwd
...
Examples:
  ...
  clawpage scaffold stock-analysis-terminal ./.pages/tsla    # → ./.pages/tsla (cwd-relative)
...
async function main() {
  ...
  const dst = resolvePageDir(targetDir);
